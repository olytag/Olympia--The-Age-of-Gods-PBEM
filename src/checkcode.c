...
char *int_to_code(int l) {
    ...
    if (l < 10000) {
        ...
        a = l % 26;
        b = l / 26;
        sprintf(ccbuf, "%c%c%02d", letters[b], letters[a], n);
    } else if (l < 26760) { /* CCN */
        l -= 20000;
        n = l % 10;
        l /= 10;
        a = l % 26;
        b = l / 26;
        sprintf(ccbuf, "%c%c%d", letters[b], letters[a], n);
    } else if (l < 33520) { /* CNC */
        l -= 26760;
        n = l % 26;
        l /= 26;
        a = l % 10;
        b = l / 10;
        sprintf(ccbuf, "%c%d%c", letters[b], a, letters[n]);
    } else if (l < 36120) { /* CNN */
        l -= 33520;
        n = l % 10;
        l /= 10;
        a = l % 10;
        b = l / 10;
        sprintf(ccbuf, "%c%d%d", letters[b], a, n);
    } else { /* CCNC */
        l -= 36120;
        a = l % 26;
        l /= 26;
        ...
        c = l % 26;
        l /= 26;
        sprintf(ccbuf, "%c%c%d%c", letters[l], letters[c], b, letters[a]);
    }
    return ccbuf;
}
